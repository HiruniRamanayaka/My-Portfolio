        ...
        <Container id="education">
          <Box sx={{ display: 'flex', gap: 8 }}>
            <Box sx={{ textAlign: 'left', flex: 1, borderLeft: 1, borderColor: 'grey.300', pl: 2 }}>
              ...
              <Typography variant="caption" sx={{lineHeight: 1.6}}>2023 – Present</Typography>
            </Box>
            <Box sx={{ textAlign: 'left', flex: 1, borderLeft: 1, borderColor: 'grey.300', pl: 2}}>
              ...
              <Typography variant="body2" sx={{lineHeight: 1.6}}>Physical Science Stream</Typography>
              <Typography variant="caption" sx={{lineHeight: 1.6}}>2021</Typography>
            ...
            <Box sx={{ textAlign: 'left', flex: 1, borderLeft: 1, borderColor: 'grey.300', pl: 2}}>
              ...
              <Typography variant="body1" sx={{lineHeight: 1.6}}>Bandaranayake Central Collage Veyangoda</Typography>
              <Typography variant="caption" sx={{lineHeight: 1.6}}>2017</Typography>
